...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// // cat1.getUsuarios().addAll(Arrays.asList(u1, u4));
		// // cat2.getUsuarios().addAll(Arrays.asList(u1, u2, u3, u4));
		// // cat3.getUsuarios().addAll(Arrays.asList(u1));
		// // cat4.getUsuarios().addAll(Arrays.asList(u1));
		// // cat5.getUsuarios().addAll(Arrays.asList(u1));
		// // cat6.getUsuarios().addAll(Arrays.asList(u1));
		// // cat6.getUsuarios().addAll(Arrays.asList(u1));

		// // u1.getCategorias().addAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		// // u2.getCategorias().addAll(Arrays.asList(cat2));
		// // u3.getCategorias().addAll(Arrays.asList(cat2));
		// // u4.getCategorias().addAll(Arrays.asList(cat1, cat2));
		...
		// ItemSolicitacao ip1 = new ItemSolicitacao(ped1, u1, 0.00, 1, 2000.00);
		// ItemSolicitacao ip2 = new ItemSolicitacao(ped1, u3, 0.00, 2, 80.00);
		// ItemSolicitacao ip3 = new ItemSolicitacao(ped2, u2, 100.00, 1, 800.00);
		
		// ped1.getItens().addAll(Arrays.asList(ip1, ip2));
		// ped2.getItens().addAll(Arrays.asList(ip3));
		
		// u1.getItens().addAll(Arrays.asList(ip1));
		// u2.getItens().addAll(Arrays.asList(ip3));
		// u3.getItens().addAll(Arrays.asList(ip2));
